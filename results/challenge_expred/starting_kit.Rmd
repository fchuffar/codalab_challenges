...
[2] Save the file contained into challenge_ssd2019_public_data in the same folder than the starting kit.

[3] Go to the strating-kit directory and launch in R the following command: `rmarkdown::render("starting_kit.Rmd")`

It procudes the file "starting_kit.html" that explains how to analyse data and produce results.

[4] Generate a missing value prediction and submit in (zip file) in the Participate tab of the codalab challenge.

Please see a detailed example of submission script in the *V. Submission* section
